...
public class MenuManager : MonoBehaviour {
    ...
    private void Start()
    {
        ...
        Title = tf.FindChild("Title").gameObject;
        LevelSelectionButton = tf.FindChild("LevelSelection").gameObject;
        QuitButton = tf.FindChild("Quit").gameObject;
        BackButton = tf.FindChild("Back").gameObject;
