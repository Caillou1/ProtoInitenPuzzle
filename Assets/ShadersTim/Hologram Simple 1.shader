...
Shader "Tim/Hollogram"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_60_0 = pow( ( 1.0 - saturate( dot( UnpackScaleNormal( tex2D( _RimNormalMap,( ( ( Speed / 1000.0 ) * _Time ) + float4( i.texcoord_0, 0.0 , 0.0 ) ).xy) ,2.0 ) , float4( normalize( i.viewDir ) , 0.0 ) ) ) ) , ( 10.0 - _RimPower ) );
...
/*ASEBEGIN
Version=7003
138;589;1906;903;4262.354;-400.6079;2.5;True;True
...
Node;AmplifyShaderEditor.CommentaryNode;169;-3021.51,-122.5578;Float;False;2344.672;617.4507;Comment;18;58;57;119;55;63;62;64;68;60;65;59;66;163;158;162;167;166;165;Rim
...
ASEEND*/
//CHKSM=33C358FE75B15EA3FCE19772088668BFFC5193A1