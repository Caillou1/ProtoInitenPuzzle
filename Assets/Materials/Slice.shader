...
Shader "Tim/Slice"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float mulTime105 = _Time.y * 0.01;
			float cos104 = cos( mulTime105 );
			float sin104 = sin( mulTime105 );
			float2 rotator104 = mul(ase_worldPos.y - float2( 0.5,0.5 ), float2x2(cos104,-sin104,sin104,cos104)) + float2( 0.5,0.5 );
			float mulTime14 = _Time.y * -0.01;
			float2 temp_cast_1 = (mulTime14).xx;
			float2 temp_cast_2 = (0.8).xx;
			float mulTime101 = _Time.y * -0.01;
			float cos102 = cos( mulTime101 );
			float sin102 = sin( mulTime101 );
			float2 rotator102 = mul(ase_worldPos.x - float2( 0.5,0.5 ), float2x2(cos102,-sin102,sin102,cos102)) + float2( 0.5,0.5 );
			float mulTime23 = _Time.y * 0.0;
			float2 temp_cast_3 = (mulTime23).xx;
			float2 temp_cast_4 = (0.0).xx;
			float mulTime100 = _Time.y * 0.01;
			float cos98 = cos( mulTime100 );
			float sin98 = sin( mulTime100 );
			float2 rotator98 = mul(ase_worldPos.z - float2( 0.5,0.5 ), float2x2(cos98,-sin98,sin98,cos98)) + float2( 0.5,0.5 );
...
/*ASEBEGIN
Version=7003
-188;728;1785;903;1003.399;254.6028;1.3;True;True
...
Node;AmplifyShaderEditor.SimpleTimeNode;101;-186.6995,583.2795;Float;False;0;FLOAT;-0.01;False;FLOAT
Node;AmplifyShaderEditor.SimpleTimeNode;105;-253.9974,148.6469;Float;False;0;FLOAT;0.01;False;FLOAT
Node;AmplifyShaderEditor.SimpleTimeNode;100;-63.99947,1074.829;Float;False;0;FLOAT;0.01;False;FLOAT
...
Node;AmplifyShaderEditor.WorldPosInputsNode;25;-270.1023,896.0745;Float;False;FLOAT3;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.SimpleTimeNode;14;-128.7012,-123.5258;Float;False;0;FLOAT;-0.01;False;FLOAT
...
ASEEND*/
//CHKSM=09CFE85731FB52ABC72814FF187568BDFFF012F1